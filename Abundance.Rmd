...
if(paralleljags){
  ...
  #Inits
  InitStage <- function(){list(beta1=rep(0.5,Dat$Birds),alpha=rep(0.5,Dat$Birds),intercept=0,sigma_int=0.1,sigma_beta1=0.1,sigma_beta2=0.1,gamma1=0,gamma2=0)}
 ...
 #Input Data
  Dat <- list(
    ...
    #Inits
  InitStage <- function() {list(beta1=rep(0.5,Dat$Birds),beta2=rep(0.5,Dat$Birds),alpha=rep(0.5,Dat$Birds),intercept=0,sigma_int=0.1,sigma_beta1=0.1,sigma_beta2=0.1,gamma1=0,gamma2=0)}
...
if(paralleljags){
  ...
  #Parameters to track
  ParsStage <- c("detect","alpha","beta1","beta2","intercept","sigma_int","sigma_beta1","ynew","gamma1","gamma2","fit","fitnew")
