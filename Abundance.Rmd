...
#Parameters to track
ParsStage <- c("detect","alpha","beta","intercept","gamma","sigma_int","sigma_slope","N","polybeta","sigma_polyslope","polygamma","fit","fit.new")
...
```{r}
fitstat<-pars[pars$par %in% c("fit","fit.new"),]
fitstat<-dcast(fitstat,...~par,value.var="estimate")
```
