...
#Compared to a multomial

Several studies follow Vasquez 2009 in fitting a multinomial relationship to frequency and interaction probabilities.

```{r}
m<-traitmatchT/sum(traitmatchT)
mat<-acast(obs,Hummingbird~Iplant_Double,value.var="Yobs",fun.aggregate = sum)
