...
niave_fitnew<-trajState(alpha=rep(niavecoef[1],100),beta=rep(niavecoef[2],100),beta2=rep(niavecoef[3],100),x=it,observed=pstate)
...
ymax<-round((c(ddat$fit,ddat$fitnew)))
