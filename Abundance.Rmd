...
if(paralleljags){
  ...
  #Parameters to track
  ParsStage <- c("alpha","beta","intercept","sigma_int","sigma_slope","ynew","gamma","fit","fitnew","Day")
...
if(paralleljags){
  ...
  Dat<-list("Yobs","Bird","Plant","Time","Plants","Traitmatch","Birds","Nobs","Ninit","Day","Days","Camera","Cameras")
