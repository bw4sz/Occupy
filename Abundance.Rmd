...
```{r}
pars<-extract_par(sim_niave,data=obs)
```
...
p<-ggplot(pars[pars$par %in% c("gamma","intercept","sigma_int","sigma_slope","sigma_polyslope"),],aes(x=estimate)) + geom_histogram() + ggtitle("Hierarchical Posteriors") + facet_grid(~par,scale="free") + theme_bw() 
