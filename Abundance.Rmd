...
indatT<-dcast(indat,...~Time,value.var="Yobs")
...
br<-c(1,3,3,2,2,3,2,3,1,2,2,3,3,2,1,3,3,3,3)
...
pr<-c(2,2,3,3,3,1,3,1,2,2,3,3,3,3,3,2,1,3,2,1,3,1,2,2,2,2,3,3,2,3,1,2,3,3,1,3,1,3,1)

elevP<-data.frame(Species=keepp,Range=pr)
