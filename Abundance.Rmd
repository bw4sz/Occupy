...
rm(bydraw,pars,Ndetect,pars_niave,N_niave)
gc()
```
...
runs<-30000
recompile(sim_niave)
sim_niave<-update(sim_niave,n.iter=runs,n.burnin=runs*.98)
gc()
```
...
sim_detect<-update(sim_detect,n.iter=runs,n.burnin=runs*.98,n.thin=5)
```
