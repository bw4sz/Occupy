...
fl.morph<-read.csv("InputData/FlowerMorphology.csv",sep="")
...
hum.morph<-read.csv("InputData/HummingbirdMorphology.csv",sep="")
...
int<-read.csv("InputData/HummingbirdInteractions.csv",sep="")
...
flower.month<-group_by(full.fl,Month,Year,Date_F) %>% dplyr::summarise(Flowers=sum(Total_Flowers,na.rm=TRUE))  %>% filter(Flowers>20)
