...
# Which covariate estimates do not overlap with 0?
```{r}
...
ggplot(dmat,aes(x=Iplant_Double,y=E,col=L1)) + geom_point(size=4) + coord_flip()+ labs(color="Model",y="Average Discrepancy")
...
### Compare to mean empirical value.
```{r}
