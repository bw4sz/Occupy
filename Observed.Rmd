...
print.noquote(readLines("Bayesian//NoDetectNmixturePoissonRagged.R"))
  ...
  Dat<-list("Yobs","Bird","extra","Plant","Plants","Camera","Cameras","Traitmatch","Birds","Ninit","Nobs","nb","nt","nc","ni")
...
print.noquote(readLines("Bayesian//NmixturePoissonRagged.R"))
  ...
  #Parameters to track
  ParsStage <- c("detect","extra","alpha","beta1","alpha_mu","beta1_sigma","beta1_mu","ynew","fit","fitnew","E")
...
print.noquote(readLines("Bayesian//NmixturePoissonRagged_Abundance.R"))
  ...
  Dat<-list("Yobs","Bird","extra","Plant","Plants","Traitmatch","Birds","Nobs","Ninit","Time","Times","resources","nc","nb","ni","nt")
