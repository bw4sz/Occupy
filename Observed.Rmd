...
print.noquote(readLines("Bayesian//NmixturePoissonRagged.R"))
  ...
  #Inits
  InitStage <- function() {list(beta1=rep(0.5,Birds),alpha=rep(0.5,Birds),alpha_mu=0,beta1_sigma=0.1,N=Ninit,beta1_mu=0)}
  
  #Parameters to track
  ParsStage <- c("detect","alpha","beta1","alpha_mu","sigma_alpha","beta1_sigma","beta1_mu","fit","fitnew","dprior","sigma_detect","ynew")
