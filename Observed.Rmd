...
ggplot(md,aes(x=Days,fill=L1,y=mean,ymin=lower,ymax=upper)) + geom_ribbon(alpha=.5) + geom_line() + facet_wrap(~L1,ncol=2) + geom_hline (yintercept=.5,linetype="dashed") + ylab("Probability of Detection") + scale_fill_discrete(guide="none") + theme_bw()
ggsave("Figures/AppendixB.jpeg",height=9,width=5,dpi=300) + scale_x_continuous(breaks=seq(0,10,2))
```
