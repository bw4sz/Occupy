...
#Inits
InitStage <- function() {list(beta=rep(0.5,Dat$Birds),alpha=rep(0.5,Dat$Birds),gamma=0,intercept=0,tau_alpha=0.1,tau_beta=0.1,N=initY)}
...
pars_dniave$Model<-"Without Detection"
```
...
pars_detect<-extract_par(m2,data=indat,Bird="Bird",Plant="jPlant")
