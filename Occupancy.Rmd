...
###Posterior Distributions
p<-ggplot(pars[pars$par %in% c("detect"),],aes(x=estimate)) + geom_histogram() + ggtitle("Estimate of parameters") + facet_wrap(~species,scale="free") + theme_bw() + ggtitle("Detection Probability")
