...
library(dplyr)
library(stringr)
opts_chunk$set(message=FALSE,warning=FALSE,fig.width=6,fig.height=4,echo=FALSE,cache=FALSE,cache.path = 'jp_cache/',fig.align='center')
...
```{r,cache=FALSE,eval=TRUE,fig.height=11,fig.width=10}
...
#Simulation 3: Hierarcichal Occupancy and Detection
