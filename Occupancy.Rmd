...
obsr<-melt(obs)
colnames(obsr)<-c("Hummigbird","Plant","Month","Presence")
obsragged<-obsr[!is.na(obsr$Presence),]
```
...
# Simulations to do
  ...
  * Variable sampling for each plant species, model needs to take in a ragged array
