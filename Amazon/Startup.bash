...
instance_id=$(aws ec2 run-instances --image-id ami-ee6da48e --security-group-ids sg-890a37ed --count 1 --instance-type t2.medium --key-name rstudio --instance-initiated-shutdown-behavior stop --query 'Instances[0].{d:InstanceId}' --output text)

# wait until instance is up and running
aws ec2 wait instance-running --instance-ids $instance_id

#add name tag
aws ec2 create-tags --resources $instance_id --tags Key=Name,Value=ExtraOccupysimulation
